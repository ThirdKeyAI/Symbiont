...
# Add upstream remote
git remote add upstream https://github.com/thirdkey/symbiont.git
```
...
2. **[Find a good first issue](https://github.com/thirdkey/symbiont/labels/good%20first%20issue)**
3. **[Join the discussion](https://github.com/thirdkey/symbiont/discussions)**
