...
[English](reasoning-loop.md) | **中文简体** | [Español](reasoning-loop.es.md) | [Português](reasoning-loop.pt.md) | [日本語](reasoning-loop.ja.md) | [Deutsch](reasoning-loop.de.md)

---

Symbiont 智能体推理循环完整指南：一个通过类型状态强制的 Observe-Reason-Gate-Act (ORGA) 循环，用于自主智能体行为。
{: .fs-6 .fw-300 }
