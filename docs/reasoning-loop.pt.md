...
[English](reasoning-loop.md) | [中文简体](reasoning-loop.zh-cn.md) | [Español](reasoning-loop.es.md) | **Português** | [日本語](reasoning-loop.ja.md) | [Deutsch](reasoning-loop.de.md)

---

Guia completo do loop de raciocínio agêntico do Symbiont: um ciclo Observe-Reason-Gate-Act (ORGA) com imposição de typestate para comportamento autônomo de agentes.
{: .fs-6 .fw-300 }
