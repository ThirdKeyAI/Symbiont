...
[English](contributing.md) | [中文简体](contributing.zh-cn.md) | [Español](contributing.es.md) | [Português](contributing.pt.md) | **日本語** | [Deutsch](contributing.de.md)

---

Symbiontプロジェクトへの貢献方法について、イシュー報告からコード変更の提出まで説明します。
{: .fs-6 .fw-300 }
