...
title: Contribuindo
nav_exclude: true
description: "Como contribuir para o projeto Symbiont"
---
...
[English](contributing.md) | [中文简体](contributing.zh-cn.md) | [Español](contributing.es.md) | **Português** | [日本語](contributing.ja.md) | [Deutsch](contributing.de.md)

---

Aprenda como contribuir para o projeto Symbiont, desde relatar problemas até enviar alterações de código.
{: .fs-6 .fw-300 }
