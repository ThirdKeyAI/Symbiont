...
## Runtime HTTP API (Development Preview)

> **⚠️ Development Preview**: This API is currently incomplete and under active development. Endpoints and data structures are subject to change without notice. Use only for development and testing purposes.

The Runtime HTTP API provides direct access to the Symbiont runtime for workflow execution, agent management, and system monitoring.
