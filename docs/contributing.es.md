...
[English](contributing.md) | [中文简体](contributing.zh-cn.md) | **Español** | [Português](contributing.pt.md) | [日本語](contributing.ja.md) | [Deutsch](contributing.de.md)

---

Aprenda como contribuir al proyecto Symbiont, desde reportar problemas hasta enviar cambios de codigo.
{: .fs-6 .fw-300 }
