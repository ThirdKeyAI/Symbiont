...
async fn test_isolation_levels() {
    ...
    let levels = [IsolationLevel::None,
        IsolationLevel::Low,
...
async fn test_execution_modes() {
    ...
    let modes = [ExecutionMode::Persistent,
...
async fn test_capabilities() {
    ...
    let capabilities = [Capability::FileSystem,
        Capability::Network,
        Capability::Database,
...
async fn test_load_balancing_strategies() {
    ...
    let strategies = [LoadBalancingStrategy::RoundRobin,
...
async fn test_encryption_algorithms() {
    ...
    let algorithms = [EncryptionAlgorithm::Aes256Gcm,
...
async fn test_recovery_strategies() {
    ...
    let strategies = [RecoveryStrategy::Retry {
            max_attempts: 3,
...
async fn test_error_handler_types() {
    ...
    let error_types = [ErrorType::ResourceExhaustion,
